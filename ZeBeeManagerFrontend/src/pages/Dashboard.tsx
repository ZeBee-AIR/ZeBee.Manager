                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                                <PieChart>
                                    <Pie data={businessLogic.activeClientsBySquadData} cx="50%" cy="50%" labelLine={false} label={({ name, value }) => `${name}: ${value}`} margin={{ top: 5, right: 5, bottom: 5, left: 5 }} innerRadius={60} outerRadius={80} fill="#8884d8" dataKey="value" >
