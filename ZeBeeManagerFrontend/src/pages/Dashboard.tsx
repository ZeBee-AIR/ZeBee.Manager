                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                                <PieChart>
                                    <Pie data={businessLogic.activeClientsBySquadData} cx="50%" cy="50%" labelLine={false} label={({ name, value }) => `${name}: ${value}`} innerRadius={60} outerRadius={80} fill="#8884d8" dataKey="value" >
